...
import masterspringmvc.masterspringmvc.profile.UserProfileSession;
...
public class PictureUploadController {
    ...
    @Autowired
    public PictureUploadController(PictureUploadProperties uploadProperties,MessageSource messageSource,UserProfileSession userProfileSession) throws IOException {
